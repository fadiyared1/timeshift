...
<body>
    <div class="flex flex-col">
        ...
        <div class="flex h-screen -mt-16 overflow-y-auto bg-gray-100">
                                ...
                                <div class="bg-white grid grid-cols-6 gap-x-3 px-6">
                                    ...
                                    <div class="py-2 text-center">
                                        <div class="relative inline">
                                            <button class="w-6 h-6 focus:outline-none users_actions">
            ...
            <a href="/admin/{{$user->id}}/delete"><button type="button" class="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-red-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-red-500 focus:outline-none focus:border-red-700 focus:shadow-outline-red transition ease-in-out duration-150 sm:text-sm sm:leading-5">
              Delete
            </button></a>
          </span>
                            ...
                            <form class="w-1/4 mx-auto bg-white p-5 rounded-lg" method="POST" action="{{ route('edituser') }}">
                                ...
                                <div>
                                  ...
                                  Name
                                                ...
                                                <div class="mt-1">
                                                    <input required id="name" class="form-input border border-gray-400 rounded-md py-1 px-2 focus:outline-none text-gray-700 block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" name="name" value="{{ $user->name }}"/>
                                                </div>
                                            </div>
                                  ...
                                  Email address
                                                ...
                                                <div class="mt-1 rounded-md shadow-sm">
                                                    <input required id="email" type="email" class="form-input border border-gray-400 rounded-md py-1 px-2 focus:outline-none text-gray-700 block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" name="email" value="{{$user->email}}" required autocomplete="email"/>
                                                </div>
                                            </div>
                                  ...
                                  Job
                                                ...
                                                <div class="mt-1 rounded-md shadow-sm">
                                                    <input required id="street_address" class="form-input border border-gray-400 rounded-md py-1 px-2 focus:outline-none text-gray-700 block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" name="job" value="{{$user->job}}" required autocomplete="job"/>
                                                </div>
                                            </div>
                                  ...
                                  Password
                                                ...
                                                <div class="mt-1 rounded-md shadow-sm">
                                                    <input required type="password" id="city" class="form-input border border-gray-400 rounded-md py-1 px-2 focus:outline-none text-gray-700 block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" name="password" required autocomplete="new-password"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
